...
All data will be handled safely and securely under a strict data policy and will not be given to third parties without permission. Data not under one of the licenses listed below will only be used internally for model development. However, we encourage open data; this will be our first paper's basis. \
